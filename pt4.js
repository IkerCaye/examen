window.onload = function() {
  ...
  // Refer̬ncia al formulari html amb id="dades"
  var forDades = document.getElementById('dades');
  // Refer̬ncia a tots els input del formulari. Es desa en un array
  ...
  if (localStorage.getItem(nomItem)){
    ...
    for (var i=0; i<inputs.length;i++) {
      // S'obt̩ la refer̬ncia a l'element HTML
