...
window.onload = function () {
  ...
  item = ["DescripciÃ³","Quantitat","Preu","Import"];
  var tb = document.getElementById("disponible");
  var tbn = document.getElementById("pendent");
    // L'array carreto contÃ© els camps dels productes
    ...
    //Es generen les celÂ·les per a cada item del carreto
        ...
        for (var j =0;j<carreto[i].length;j++){
          var td = document.createElement("td");
            ...
            if (j==3){
              ...
              // Si l'article estÃ  disponible se suma l'import al total
            ...
            tr.appendChild(td);
            if (carreto[i][3]){
              // ES POT SIMPLIFICAR EL CODI AMB UNA FUNCIÃ“
              // Comprova si la capÃ§alera existeix
